...
class ContratoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Contrato::create(['cliente_id' => 2, 'data_inicio' => '2025-01-10', 'data_fim' => null, 'status' => true]);
        ...
        Contrato::create(['cliente_id' => 9, 'data_inicio' => '2025-05-01', 'data_fim' => null, 'status' => true]);
